...
- TST-002/GEN-023 skip two rare GEN-028 occupancy misses (`balanced-11` at 128 leaves a 1-cell avenue gap; districtCount 8 with urban/park extremes can exceed a 2-cell carriageway). Fixture stitch tests still cover GEN-028; the generator still rejects those maps.
