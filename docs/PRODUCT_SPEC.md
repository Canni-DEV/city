...
City is a modern browser-based creative sandbox for generating a convincing static city and reshaping its objects. It emphasizes readable organic structure and playful authorship, not simulation.
...
- **PRD-006:** The product has no goals, economy, traffic, pedestrians, accounts, server dependency, telemetry, onboarding, or PWA behavior.
...
- **AC-004:** M0–M6, their mapped requirements, and all manual QA checks are complete before `1.0.0`.

## Out of scope for v1

Simulation systems, road editing, zoning editing, bridges, ramps, multilevel networks, multiplayer, cloud sync, mobile-first controls, seasons, time of day, audio, and heavy post-processing.
