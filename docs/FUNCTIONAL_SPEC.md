...
- **FUN-046:** Generator `0.8.0` cities include deterministic park interiors (GEN-032) as ordinary entities: a civic plaza in habitable park manzanas and a grove in pocket remnants. There is no dedicated park UI; M4 edits them like other decorations. Pedestrians and vehicles do not gain new orders or sit-points.
