...
| M3.8.1 | Locked third-person NPC follow, city `maxZoom` 96, deterministic yield recovery | TST-013 camera/locomotion, browser QA |
| M3.9 | Optional hybrid HTML/R3F cinematic route, native-scroll city reveal and controlled-NPC handoff | TST-014, backend/accessibility/browser QA |
