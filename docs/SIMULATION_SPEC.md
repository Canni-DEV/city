...
- **SIM-009:** Pedestrian crossings are local T and 4-way Kenney `*-path` tiles and their immediate occupied-road arms, arterial/collector T and 4-way `road-intersection` / `road-crossroad` cells and their arms, sidewalk-corner road cells, and the four approach cells of a 3×3 roundabout. There are no mid-block crosswalks.
