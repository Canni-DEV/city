...
The “no 2-cell-wide carriageways” exclusion of this milestone is **superseded** by the M3.6.1 avenue hotfix (`docs/milestones/M3_6_1_AVENUES.md`, generator `0.6.5`): arterial/collector corridors are now intentional 2-cell carriageways with designed dual L/T/4-way blocks. This brief is not rewritten as if M3.5 already shipped that geometry.
