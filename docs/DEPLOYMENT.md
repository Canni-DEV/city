...
- The production bundle includes the directly addressable but unlinked `#/experience` route. It uses only existing catalog assets and has no server, telemetry or rewrite requirement.
