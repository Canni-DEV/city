...
- **PER-005:** Export emits formatted UTF-8 `.city.json` with schema, snapshot, and provenance but no undo history, runtime vehicles, reconstructed lane geometry, caches, or diagnostic overlay selection.
