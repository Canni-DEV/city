...
- The product is local-only: no telemetry, server dependency, accounts, economy, traffic, or pedestrians.

## Scope boundaries

- Do not modify source files under `assets/`.
- Do not add elevated roads, road editing, zoning editing, PWA support, audio, simulation, or heavy post-processing in v1.
