...
- The product is local-only: no telemetry, server dependency, accounts, economy, or vehicle traffic. A bounded runtime pedestrian layer (M3.6 / SIM-001–007) is in scope; massive crowds are not.
